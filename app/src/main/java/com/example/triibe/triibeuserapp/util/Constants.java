...
public final class Constants {
    ...
    static {
        TEST_MALLS.put("southland", new LatLng(-37.958388, 145.052658));
    }

    public static final HashMap<String, LatLng> TEST_LANDMARKS = new HashMap<>();
    static {
        TEST_LANDMARKS.put("furtherSouth", new LatLng(-37.982068, 145.07188));
        TEST_LANDMARKS.put("eastSide", new LatLng(-37.958201, 145.056192));
        TEST_LANDMARKS.put("westSide", new LatLng(-37.958876, 145.049591));
    }
}
